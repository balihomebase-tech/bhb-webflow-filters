(function () {
  ...
  var AREA_RULES = [
    ...
    { id: 'canggu-area',   label: 'Canggu area',   keys: ['canggu', 'batu bolong', 'dalung'] },
    { id: 'pererenan-area',label: 'Pererenan area', keys: ['pererenan', 'tumbak bayuh', 'buduk', 'cemagi', 'seseh'] },
  ...
  function cacheEls() {
    ...
    for (var i = 0; i < fields.length; i++) {
      ...
      var vals = [];
      for (var j = 0; j < opts.length; j++) vals.push((opts[j].dataset.value || '').toLowerCase());
      ...
      } else if (vals.indexOf('10 \u2013 20 years') > -1 || vals.indexOf('30+ years') > -1) {
        el.leaseField    = field;
